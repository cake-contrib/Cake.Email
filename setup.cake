...
var solutionFilePath          = "./Source/Cake.Email.sln";
var solutionDirectoryPath     = "./Source/Cake.Email";
var title                     = "Cake.Email";
var resharperSettingsFileName = "Cake.Email.sln.DotSettings";
var repositoryOwner           = "cake-contrib";
var repositoryName            = "Cake.Email";
var appVeyorAccountName       = "cakecontrib";
var appVeyorProjectSlug       = "cake-Email";

// NOTE: Only populate this, if required, but leave as is otherwise.
var dupFinderExcludePattern   = new string[] { rootDirectoryPath + "/Source/Cake.Email.Tests/*.cs" };
