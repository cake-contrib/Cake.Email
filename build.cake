...
var libraryName = "Cake.Email";
var gitHubRepo = "Cake.Email";

var testCoverageFilters = new[]
{
	"+[Cake.Email]*",
	"-[Cake.Email]Cake.Email.Properties.*",
	"-[Cake.Email]Cake.Email.Models.*",
	"-[Cake.Email]*System.Text.Json.SourceGeneration*"
};
